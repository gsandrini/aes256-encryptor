...
function cryptoApp() {
  return {
    ...
    async encrypt() {
      ...
      if (!plain) {
        this.showResult(this.t.errNoInput, this.t.labelError, true);
        return;
      }
      if (!pwd) {
        this.showResult(this.t.errNoPwd, this.t.labelError, true);
        return;
      }
    ...
    async decrypt() {
      ...
      if (!cipherText) {
        this.showResult(this.t.errNoInputDec, this.t.labelError, true);
        return;
      }
      if (!pwd) {
        this.showResult(this.t.errNoPwd, this.t.labelError, true);
